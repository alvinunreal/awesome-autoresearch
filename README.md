...
- [dorukardahan/ZeroAPI](https://github.com/dorukardahan/ZeroAPI) ![GitHub stars](https://img.shields.io/github/stars/dorukardahan/ZeroAPI?style=social) - Applies the autoresearch measure-experiment-promote loop to AI model routing policy. Config-driven eval script analyzes routing logs and suggests threshold, keyword, and fallback tuning across 5 providers and 155 models.
