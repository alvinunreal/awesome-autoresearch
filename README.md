...
- [activeloopai/autoresearch_deeplake_swarm](https://github.com/activeloopai/autoresearch_deeplake_swarm) ![GitHub stars](https://img.shields.io/github/stars/activeloopai/autoresearch_deeplake_swarm?style=social) - Cloud-backed fork of upstream autoresearch where a principal agent launches parallel workers on cloud GPUs and logs experiment results and metadata to a shared Deeplake table. 
